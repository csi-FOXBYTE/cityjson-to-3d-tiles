...
export class StructuralMetadata extends ExtensionProperty<IStructuralMetadata> {
  static override readonly EXTENSION_NAME = NAME;
  ...
  protected override getDefaults(): Nullable<IStructuralMetadata> {
    return Object.assign(super.getDefaults(), {
      schema: null,
      schemaUri: null,
      propertyTables: new RefSet(),
      propertyTextures: new RefSet(),
      propertyAttributes: new RefSet(),
    });
  }
...
export class PropertyTable extends ExtensionProperty<IPropertyTable> {
  ...
  public override getDefaults(): Nullable<IPropertyTable> {
    return Object.assign(super.getDefaults(), {
      objectName: null,
      properties: new RefMap(),
    });
